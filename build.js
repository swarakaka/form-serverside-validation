...
const builds = [
  { entryPoints: ['src/index.js'], format: 'esm', outfile: 'dist/index.esm.js', platform: 'browser' },
  { entryPoints: ['src/index.js'], format: 'cjs', outfile: 'dist/index.js', platform: 'browser' },
]
